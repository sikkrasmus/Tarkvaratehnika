...
declare namespace postcss {
    ...
    interface Result {
         ...
         * This property will have a value only if the entities does not want an inline
         ...
         * the entities has set the map.inline option to false, or if PostCSS was passed
    ...
    interface Input {
        ...
        id: string;
        /**
         * The CSS source identifier. Contains input.file if the entities set the
